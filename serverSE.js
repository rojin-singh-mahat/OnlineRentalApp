...
app.post("/confirm", (req, res)=>{
    ...
    const mailOptions = {
        ...
        html: `
            ...
            <a href="${process.env.CONFIRMATION_LINK}" style="padding: 10px 20px; background-color: #4361ee; color: white; border-radius: 5px; text-decoration: none;">Confirm My Account</a>
